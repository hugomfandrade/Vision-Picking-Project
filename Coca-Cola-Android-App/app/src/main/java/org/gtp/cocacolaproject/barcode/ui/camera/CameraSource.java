...
public class CameraSource {
     ...
     */
    // changed @RequiresPermission(Manifest.permission.CAMERA)
     ...
     */
    // changed @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    public boolean setAutoFocusMoveCallback(@Nullable AutoFocusMoveCallback cb) {
        // changed if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
            return false;
        // changed }

        /* changed synchronized (mCameraLock) {
            if (mCamera != null) {
