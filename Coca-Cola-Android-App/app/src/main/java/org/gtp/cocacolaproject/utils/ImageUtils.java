...
public final class ImageUtils {
  ...
  public static void saveBitmap(final Bitmap bitmap, final String filename) {
      ...
      saveBitmap(bitmap, myDir, filename);
  }

  public static void saveBitmap(final Bitmap bitmap, final File dir, final String filename) {

    Log.i(TAG, "Saving " + bitmap.getWidth() + "x" + bitmap.getHeight() + " bitmap to " + dir.getAbsolutePath());
  ...
  public static Matrix getTransformationMatrix(
    ...
    final int inWidth = transpose ? croppedHeight : croppedWidth;
    final int inHeight = transpose ? croppedWidth : croppedHeight;
